...
import { LogOut, Layout, Settings as SettingsIcon, History, PlusCircle, Zap, User, LifeBuoy, ShieldCheck } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-8">
                        {user && (
                            <div className="hidden lg:flex items-center gap-2 bg-white/[0.03] p-1.5 rounded-2xl border border-white/5">
                                ...
                                <Link
                                    to="/support"
                                    className={`flex items-center gap-2 no-underline text-[10px] font-black tracking-widest px-4 py-2.5 rounded-xl transition-all ${isActive('/support') ? 'bg-white text-black shadow-xl' : 'text-gray-500 hover:text-white hover:bg-white/5'
                                        }`}
                                >
                                ...
                                <Link
                                    to="/admin"
                                    className={`flex items-center gap-2 no-underline text-[10px] font-black tracking-widest px-4 py-2.5 rounded-xl transition-all ${isActive('/admin') ? 'bg-white text-black shadow-xl' : 'text-gray-500 hover:text-white hover:bg-white/5'
                                        }`}
                                >
                                    <ShieldCheck className="w-4 h-4 text-tiktok-pink" />
                                    ADMIN
                                </Link>
                            </div>
                        )}
